{{-- resources/views/dashboard/bookings_bootstrap.blade.php --}}
<x-adminlayout>
  ...
  <head>
    ...
    <title>Dashboard — Booking Users</title>
    ...
    <div class="page-wrap">
      ...
      <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap">
        ...
        <div class="d-flex align-items-center gap-3 mt-3 mt-md-0">
          <div class="text-end">
            <div class="small text-muted">Welcome, <strong>Admin</strong></div>
          </div>
      ...
      <div class="row g-4 mb-4">
        <div class="col-md-6">
          <div class="card card-rounded shadow-soft stats-card p-4">
            ...
            <div class="display-6 fw-bold text-success">128</div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="card card-rounded shadow-soft stats-card p-4">
            <h5>Total Users</h5>
            <div class="display-6 fw-bold text-info">94</div>
          </div>
        </div>
      </div>
